...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=opzapp \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=opzd \
...
install: go.sum 
	go install -mod=readonly $(BUILD_FLAGS) ./cmd/opzd
...
draw-deps:
	...
	@goviz -i ./cmd/opzd -d 2 | dot -Tpng -o dependency-graph.png
